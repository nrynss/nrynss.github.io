...
> Explain the difference between `kanakkiṇakku` and `paṭṭayam` in Kerala land revenue records, in English. Also explain what a `thandaper` number is and how it relates to property identification in Kerala.
