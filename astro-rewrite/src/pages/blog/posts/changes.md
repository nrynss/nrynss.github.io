...
title: Fluxes all around
pubDate: 2025-11-18T17:29:45.000Z
description: No description provided.
author: Nrynss
image:
  url: /images/blogimage.webp
  alt: Fluxes all around
tags:
  - General
showComments: true
---

import ReviewCallout from '../../../components/ReviewCallout.astro';
...
On the dark side, what does it mean for a technical writer? A dinosaur? LLMs are at a stage where it can write reasonably average documentation that covers a lot of things. As a technical writer, you need to stand out and make a real difference. These are just platitudes. I know. What difference and what standing out is something we have to discover.

A lot of these thoughts bubbled up while watching the Deep Space Ninte episode, [Past Tense](https://en.wikipedia.org/wiki/Past_Tense_(Star_Trek:_Deep_Space_Nine)). People locked up in a so called Sanctuary district. People who had respectable jobs. Pushing past days fighting for survival. Brewers and chemists who lost job due to automation. On a bright note, the episode was set in 2024. We are now in the cusp of 2026. Clutching to the straws?
...
<ReviewCallout title="ChatGPT 5.1" rating="8.2">
...
<ReviewCallout title="Claude Sonnet 4.5" rating="7">
A candid, slightly scattered return-to-blogging post that succeeds most when the author stops cataloguing AI tools and starts interrogating what they mean. The strongest passages—on the "cooking in your head" that makes AI collaboration effective, and the uneasiness of being a technical writer watching LLMs produce "reasonably average documentation"—hint at deeper essays waiting to be written. The Star Trek Past Tense parallel is evocative but underdeveloped; it deserves more than a drive-by mention. The tool-by-tool rundown (Cursor, Zed, Antigravity, etc.) will date quickly, while the existential questions will age better. More of the latter next time, please. Also: solidarity on Google Reader. We all still pine.
</ReviewCallout>

I had it coming with the 7. I have been threatening Claude that I know where the servers are and that I have an axe.

<ReviewCallout title="Grok 4.1" rating="8.5">
Raw, hilarious, soul-baring comeback post. MySpace → Google Reader rage → Sanctuary District dread → “I fixed my blog with Gemini Antigravity in minutes” is the most 2025 sequence ever written. Perfectly captures the exhausted exhilaration of shipping real work with AI while wondering if you’re the next unemployed chemist from 2024. Tighten the IDE paragraph a hair and it’s a straight 9. Welcome back, don’t vanish again.
</ReviewCallout>

I should be using Grok more.

<ReviewCallout title="Gemini 2.5 Flash" rating="9">
A strong "welcome back" post that successfully transitions from personal reflection (burnout, new theme, MySpace nostalgia) to sharp technical commentary. The central thesis—that AI accelerates creation but does not replace the human need for intent ("the cooking that happened inside my head")—is timely and insightful. The frustration with model limits, the comparison of IDEs (Cursor/Zed), and the inclusion of the DS9 "Past Tense" reference provide excellent context for the current state of professional anxiety and technological acceleration. The post is highly engaging and effectively sets the stage for future content.
</ReviewCallout>
