...
- [Grok](https://grok.com/) Build: I registered for paid Grok and got one week free. Cancelled immediately. Sorry Elon. You are rich enough as it is. Grok Build was really good though. The coding agent was good and the model too. I could choose Composer 2.5, which I regularly use at work in [Cursor](https://www.cursor.com/). But I decided to stick with Grok since I didn't have the time to deep dive into the comparison between the two. Grok build was at 80% of the monthly limit by the end.
...
<ReviewCallout title="SEA LION Finetune of Qwen 27B" rating="9/10">
